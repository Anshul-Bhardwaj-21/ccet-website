...
import crowd3 from './gallery-images/crowd3.webp'
import senior from './gallery-images/senior.webp'
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {events.map((event, i) => (
          <div key={i} className="bg-white text-black rounded-3xl overflow-hidden shadow-md">
            <img src={event.img} alt={`Event: ${event.title}`} className="w-full h-40 object-cover" width="400" height="160" loading="lazy" />
            <div className="p-4">
