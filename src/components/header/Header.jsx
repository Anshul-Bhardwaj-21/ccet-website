...
import CCETLogo from '../../assets/header/CCET-Logo.webp';
import IndianEmblem from '../../assets/header/Indian-Emblem.webp';
      ...
      <div className="w-full bg-white md:bg-gradient-to-r md:from-blue-900 md:to-slate-900 relative z-50">
        ...
        <div className="lg:hidden w-full bg-gradient-to-r from-blue-900 to-slate-900 shadow">
          <div className="w-full px-4 py-3 flex items-center justify-between">
            <img src={CCETLogo} alt="CCET Chandigarh official logo" className="h-10 w-auto" width="96" height="40" />
            ...
            <img src={IndianEmblem} alt="Indian Emblem, Government of India" className="h-10 w-auto" width="40" height="40" />
          </div>
        ...
        <div className="hidden lg:flex flex-col items-center px-2 py-3 w-full max-w-[1436px] mx-auto">
          <div className="flex w-full items-center justify-center gap-2">
            <div className="flex items-center h-full mx-14 min-w-[96px]">
              <img className="h-24 w-auto object-contain" src={CCETLogo} alt="CCET Chandigarh official logo" width="96" height="96" />
            </div>
            ...
            <div className="flex items-center h-full mx-14 min-w-[96px]">
              <img className="h-24 w-auto object-contain" src={IndianEmblem} alt="Indian Emblem, Government of India" width="96" height="96" />
            </div>
          </div>
